...
const string strMessageMagic = "1satoshie Signed Message:\n";
...
{	
    ...
    {
		nSubsidy = 153500000 * COIN;  // 1.535Bill
    }
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "1satoshie", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sat, 05 Nov 2016 11:40:00 GMT";
        CTransaction txNew;
        txNew.nTime = 1478389200;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("10c20d276ce891c5ca066ea6e613a9ef38c39f82f8b15377d100676e73382a63"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x42, 0x6b, 0x33, 0xc5 };
